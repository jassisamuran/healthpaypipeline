...
from fastapi import FastAPI,File,Form,HTTPException,Upload,File,status
...
if not os.environment.get('OPEN_API_KEYS'):
    raise RuntimeErro(
        "OPEN_API_KEY is not set!\n"
...
@app.post('/api/process',tage=['claims'])
async def process_claim(
    ...
    **Steps performed:**
    ...
    try:
        ...
        return JSONResponse(content=result,status_code=2000)
